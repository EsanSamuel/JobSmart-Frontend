          ...
          <div className="flex gap-2 items-center mb-6">
            <div className="flex w-full items-center gap-2 border px-3 rounded-full py-2 border-gray-300 ">
              ...
              <Input
                ...
                value={search}
                className="h-10 outline-none border-0 focus-visible:ring-0 xl:text text-[13px] shadow-none"
              />
              <Button
                type="submit"
          ...
          <div className="flex gap-6 h-full">
            <div className="flex flex-col w-full lg:w-[45%] xl:w-[420px] min-h-0">
              <div className="flex justify-between items-center mb-4">
                <h1 className="lg:text-2xl text-[18px] font-bold  text-gray-800 shrink-0">
                  Explore Jobs
                </h1>
                <Dialog>
                  <DialogTrigger asChild className="block md:hidden">
                    <Button className="text-[5px] py-1">
                      <SlidersHorizontal className="text-[5px]" size={5} />
                    </Button>
                  </DialogTrigger>
                  <FilterModal />
                </Dialog>
